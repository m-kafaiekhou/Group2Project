...
urlpatterns += [
    ...
    path("chart/sales/daily-time-sum/", sales_by_time_of_day, name="daily-time-sum"),
    ...
    path("chart/sales/status/<str:start_date>/<str:end_date>/<str:status>/", order_status_report, name="status"),
]
